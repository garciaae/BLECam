...
+(NSString *) CBUUIDToString:(CBUUID *)inUUID {
    ...
    if (inUUID.data.length == 2) {
        ...
        uint32_t g1 = (uint32_t) ((i[0] << 24) | (i[1] << 16) | (i[2] << 8) | i[3]);
        uint16_t g2 = (uint16_t)((i[4] << 8) | (i[5]));
        uint16_t g3 = (uint16_t)((i[6] << 8) | (i[7]));
        uint16_t g4 = (uint16_t)((i[8] << 8) | (i[9]));
        uint16_t g5 = (uint16_t)((i[10] << 8) | (i[11]));
        uint32_t g6 = (uint16_t)((i[12] << 24) | (i[13] << 16) | (i[14] << 8) | i[15]);
