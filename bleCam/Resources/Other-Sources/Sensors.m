...
-(id) initWithCalibrationData:(NSData *)data {
    ...
    if (self) {
        ...
        self.c5 = (int16_t)((scratchVal[8] & 0xff) | ((scratchVal[9] << 8) & 0xff00));
        self.c6 = (int16_t)((scratchVal[10] & 0xff) | ((scratchVal[11] << 8) & 0xff00));
        self.c7 = (int16_t)((scratchVal[12] & 0xff) | ((scratchVal[13] << 8) & 0xff00));
        self.c8 = (int16_t)((scratchVal[14] & 0xff) | ((scratchVal[15] << 8) & 0xff00));
    }
    return self;
}
-(int) calcPressure:(NSData *)data {
    ...
    temp = (int16_t)(scratchVal[0] & 0xff) | ((scratchVal[1] << 8) & 0xff00);
...
-(float) calcXValue:(NSData *)data {
    ...
    self.lastX = (float)(((float)rawX * 1.0) / ( 65536 / IMU3000_RANGE )) * -1;
...
-(float) calcYValue:(NSData *)data {
    ...
    self.lastY = (float) (((float)rawY * 1.0) / ( 65536 / IMU3000_RANGE )) * -1;
...
-(float) calcZValue:(NSData *)data {
    ...
    self.lastZ = (float)((float)rawZ * 1.0) /(float)( 65536 / IMU3000_RANGE );
...
-(float) calcXValue:(NSData *)data {
    ...
    [data getBytes:&scratchVal length:6];
    int16_t rawX = (int16_t)(scratchVal[0] & 0xff) | ((scratchVal[1] << 8) & 0xff00);
    self.lastX = (float)(((float)rawX * 1.0) / ( 65536 / MAG3110_RANGE )) * -1;
    return (self.lastX - self.calX);
}
-(float) calcYValue:(NSData *)data {
    //Orientation of sensor on board means we need to swap Y (multiplying with -1)
    ...
    [data getBytes:&scratchVal length:6];
    int16_t rawY = (int16_t)((scratchVal[2] & 0xff) | ((scratchVal[3] << 8) & 0xff00));
    self.lastY = (float)(((float)rawY * 1.0) / ( 65536 / MAG3110_RANGE )) * -1;
    return (self.lastY - self.calY);
}
-(float) calcZValue:(NSData *)data {
    char scratchVal[6];
